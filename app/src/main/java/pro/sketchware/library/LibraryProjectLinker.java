...
public class LibraryProjectLinker {
    ...
    @SuppressWarnings("unused") private static String _legacyRead(File f) throws IOException {
    ...
    private static void writeFileString(File f, String content) throws IOException {
        // Proposal 19: atomic write via AtomicFileWriter
        AtomicFileWriter.write(f, content);
        if (true) return;  // skip legacy path below
