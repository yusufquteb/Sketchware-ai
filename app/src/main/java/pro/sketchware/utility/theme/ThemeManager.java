...
public class ThemeManager {
    ...
    /** Calm premium indigo — focus mode, study, deep work. Default. */
    ...
    public static int getPreset(Context context) {
        // Default: Neutral Clean (3) — clean professional look out of the box
        return prefs(context).getInt(KEY_PRESET, PRESET_NEUTRAL);
    }
