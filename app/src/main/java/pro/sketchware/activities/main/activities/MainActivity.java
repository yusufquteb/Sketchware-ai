...
public class MainActivity extends BasePermissionAppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (PermissionsActivity.shouldShowOnFirstRun(this)) {
            ...
            intent.putExtra(PermissionsActivity.EXTRA_ONBOARDING, true);
        ...
        // Storage/all-files-access prompts used to appear here on every launch.
        // They've been replaced by the consolidated onboarding permissions
        // screen (PermissionsActivity) shown once on first run.
        ...
        if (Intent.ACTION_VIEW.equals(getIntent().getAction())) {
            ...
            // Auto-acknowledge the major changes reminder so it never shows on fresh install.
