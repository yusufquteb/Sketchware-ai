...
public class ProjectsFragment extends DA {
        ...
        executorService.execute(() -> {
            ...
            if (newProject != null) {
                requireActivity().runOnUiThread(() -> {
                    ...
                    // FIX: Use targeted insert notification instead of full notifyDataSetChanged
        ...
        executorService.execute(() -> {
            ...
            if (updatedProject != null) {
                ...
                if (index != -1) {
                    ...
                    // FIX: targeted update instead of full refresh
    ...
    private static class ProjectDiffCallback extends DiffUtil.Callback {
        ...
        public boolean areItemsTheSame(int oldItemPosition, int newItemPosition) {
            // FIX: a project with a corrupt/undecryptable "project" file can yield a
            // null/missing sc_id. Comparing with .equals() on a null would crash on
            // the Main thread inside dispatchUpdatesTo(). Use Objects.equals instead.
