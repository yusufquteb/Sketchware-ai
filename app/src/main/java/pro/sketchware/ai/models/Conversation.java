...
public class Conversation {
    ...
    /**
     * The project this conversation was scoped to when created (SCOPE_PROJECT),
     * or null for a workspace-wide conversation (SCOPE_GLOBAL). Previously this
     * was never persisted — a project-scoped chat would silently become a
     * multi-project one on reopen from WorkspaceConversationsFragment, since
     * only workspaceId survived. See CHANGES note "project-scope persistence".
     */
    private String projectId;

    public Conversation(String workspaceId, String title, String modelId, String providerName) {
        this(workspaceId, title, modelId, providerName, null);
    }
    ...
    private Conversation(String id, String workspaceId, String title, long createdAt, long updatedAt,
                         String modelId, String providerName, String projectId) {
        this.id = id;
        this.workspaceId = workspaceId;
        this.title = title;
    ...
    public static Conversation fromJsonObject(JsonObject json) {
        ...
        String projectId = getString(json, "projectId", null);
        return new Conversation(id, workspaceId, title, createdAt, updatedAt, modelId, providerName, projectId);
    }
