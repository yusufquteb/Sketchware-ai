...
public final class AiProviderModels {
    ...
    @SuppressWarnings("deprecation") // intentionally still handles legacy LLM7/CHUTES cases
    public static List<String> getStaticModels(AiProvider provider) {
        ...
        switch (provider) {
            ...
            // qwen/qwen3-32b: Qwen3 32B — strong Java/Android code + reasoning, 131K ctx.
            //   (Fixed: was "qwen3-32b" without the required "qwen/" prefix → Model Not Found.
            //    Also replaces qwen-qwq-32b, deprecated by Groq in favor of qwen/qwen3-32b.)
            ...
            // Removed: qwen-qwq-32b → deprecated by Groq, replaced with qwen/qwen3-32b.
            case GROQ:
                return Arrays.asList(
                        "qwen/qwen3-32b",          // Best coding + reasoning on Groq, 131K ctx, fast
