 ...
 *
 * <p><b>LEGACY — not wired into {@code AiClientFactory}.</b> The {@link AiProvider#LLM7}
 ...
 * so that {@code AiProvider.LLM7} keeps resolving for any value a user may have saved
 ...
 * confirming no shipped build ever exposed LLM7 in the UI.
 */
@SuppressWarnings("deprecation") // this entire class exists only to back the deprecated LLM7 provider
