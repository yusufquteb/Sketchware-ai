 ...
 * <pre>
 * UI ──► ChatCoordinator ──► AgentExecutorAiDelegate ──► AgentExecutor ──► ToolRegistry ──► AgentTool.execute()
 *  ▲               ▲               │                                  │
 *  │               └───────────────┘◄─────────────── callbacks ───────┘
 ...
 * <ul>
 *   <li>AI model calls — AgentExecutorAiDelegate / AgentExecutor.</li>
 *   <li>Tool execution — ToolRegistry / AgentTool.</li>
...
public class ChatCoordinator implements ChatMessageAdapter.ChatMessageListener {
    ...
    private volatile ChatState chatState = ChatState.IDLE;
    ...
    /**
     * AI response callback — implemented by AgentExecutorAiDelegate (Stage 2).
     ...
     *   <li>Delegate to AgentExecutorAiDelegate (via AiDelegate).</li>
     * </ol>
     */
    ...
    public boolean isAiResponding() { return chatState.isActive(); }
