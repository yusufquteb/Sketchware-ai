...
public class WorkspaceConversationsFragment extends Fragment
    ...
    public void onConversationClick(Conversation conversation) {
        ...
        // Fix: this conversation may have been created scoped to a single project
        // (see AiProjectIntegrationHelper.createConversation). Without re-passing
        // it here, ChatActivity always fell back to SCOPE_GLOBAL on reopen, and the
        // AI would lose track of which project it was actually talking about.
        if (conversation.getProjectId() != null && !conversation.getProjectId().isEmpty()) {
            intent.putExtra(ChatActivity.EXTRA_PROJECT_ID, conversation.getProjectId());
        }
