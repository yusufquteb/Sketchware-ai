...
public final class BuiltInDependencyRegistry {
    ...
    static {
        ...
        map.put("androidx.biometric:biometric", BuiltInLibraries.ANDROIDX_BIOMETRIC);
        map.put("androidx.core:core-splashscreen", BuiltInLibraries.ANDROIDX_CORE_SPLASHSCREEN);
        map.put("androidx.credentials:credentials", BuiltInLibraries.ANDROIDX_CREDENTIALS);
        map.put("androidx.dynamicanimation:dynamicanimation", BuiltInLibraries.ANDROIDX_DYNAMICANIMATION);
        map.put("androidx.emoji2:emoji2", BuiltInLibraries.ANDROIDX_EMOJI2);
        map.put("androidx.emoji2:emoji2-views-helper", BuiltInLibraries.ANDROIDX_EMOJI2_VIEWS_HELPER);
        map.put("androidx.graphics:graphics-shapes-android", BuiltInLibraries.ANDROIDX_GRAPHICS_SHAPES_ANDROID);
        map.put("androidx.media3:media3-common", BuiltInLibraries.ANDROIDX_MEDIA3_COMMON);
        map.put("androidx.media3:media3-exoplayer", BuiltInLibraries.ANDROIDX_MEDIA3_EXOPLAYER);
        map.put("androidx.media3:media3-exoplayer-hls", BuiltInLibraries.ANDROIDX_MEDIA3_EXOPLAYER_HLS);
        map.put("androidx.media3:media3-ui", BuiltInLibraries.ANDROIDX_MEDIA3_UI);
        map.put("androidx.preference:preference", BuiltInLibraries.ANDROIDX_PREFERENCE);
        ...
        map.put("com.android.billingclient:billing", BuiltInLibraries.ANDROID_BILLING);
        ...
        map.put("com.google.firebase:firebase-auth", BuiltInLibraries.FIREBASE_AUTH);
        map.put("com.google.firebase:firebase-common", BuiltInLibraries.FIREBASE_COMMON);
        map.put("com.google.firebase:firebase-database", BuiltInLibraries.FIREBASE_DATABASE);
        map.put("com.google.firebase:firebase-messaging", BuiltInLibraries.FIREBASE_MESSAGING);
        map.put("com.google.firebase:firebase-storage", BuiltInLibraries.FIREBASE_STORAGE);
        ...
        map.put("jp.wasabeef:glide-transformations", BuiltInLibraries.GLIDE_TRANSFORMATIONS);
