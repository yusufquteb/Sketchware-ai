...
public class BuiltInLibraries {
    ...
    // Media3 / ExoPlayer
    public static String ANDROIDX_MEDIA3_COMMON        = "media3-common-1.4.1";
    public static String ANDROIDX_MEDIA3_CONTAINER     = "media3-container-1.4.1";
    public static String ANDROIDX_MEDIA3_DATABASE      = "media3-database-1.4.1";
    public static String ANDROIDX_MEDIA3_DATASOURCE    = "media3-datasource-1.4.1";
    public static String ANDROIDX_MEDIA3_DECODER       = "media3-decoder-1.4.1";
    public static String ANDROIDX_MEDIA3_EXOPLAYER     = "media3-exoplayer-1.4.1";
    public static String ANDROIDX_MEDIA3_EXOPLAYER_HLS = "media3-exoplayer-hls-1.4.1";
    public static String ANDROIDX_MEDIA3_EXTRACTOR     = "media3-extractor-1.4.1";
    public static String ANDROIDX_MEDIA3_UI            = "media3-ui-1.4.1";

    // Shizuku
    public static String DEV_RIKKA_SHIZUKU_AIDL        = "shizuku-aidl-13.1.5";
    public static String DEV_RIKKA_SHIZUKU_API         = "shizuku-api-13.1.5";
    public static String DEV_RIKKA_SHIZUKU_PROVIDER    = "shizuku-provider-13.1.5";
    public static String DEV_RIKKA_SHIZUKU_SHARED      = "shizuku-shared-13.1.5";

    // Android Billing
    public static String ANDROID_BILLING               = "billing-7.1.1";

    // OneSignal
    public static String ONESIGNAL_CORE                = "onesignal-core-5.1.31";
    public static String ONESIGNAL_NOTIFICATIONS       = "onesignal-notifications-5.1.31";
    public static String ONESIGNAL_IN_APP_MESSAGES     = "onesignal-in-app-messages-5.1.31";
    public static String ONESIGNAL_LOCATION            = "onesignal-location-5.1.31";

    // Credential Manager
    public static String ANDROIDX_BIOMETRIC           = "biometric-1.2.0-alpha05";
    public static String ANDROIDX_CREDENTIALS         = "credentials-1.3.0";
    public static String ANDROIDX_CREDENTIALS_PLAY_AUTH = "credentials-play-services-auth-1.3.0";
    ...
    public static String PLAY_SERVICES_MEASUREMENT_API = "play-services-measurement-api-21.6.2";
    ...
    public static final BuiltInLibrary[] KNOWN_BUILT_IN_LIBRARIES = {
            ...
            // ── OneSignal ─────────────────────────────────────────────────
            new BuiltInLibrary(ONESIGNAL_CORE, List.of(ANDROIDX_APPCOMPAT, ANDROIDX_CORE,
                    ANDROIDX_FRAGMENT, ANDROIDX_LEGACY_SUPPORT_CORE_UTILS,
                    ANDROIDX_LEGACY_SUPPORT_CORE_UI, ANDROIDX_MEDIA,
                    JETBRAINS_KOTLIN_STDLIB, JETBRAINS_KOTLINX_COROUTINES_CORE_JVM,
                    JETBRAINS_KOTLINX_COROUTINES_ANDROID), "com.onesignal.core"),
            new BuiltInLibrary(ONESIGNAL_NOTIFICATIONS, List.of(ANDROIDX_WORK_RUNTIME,
                    FIREBASE_MESSAGING, ONESIGNAL_CORE, JETBRAINS_KOTLIN_STDLIB,
                    JETBRAINS_KOTLINX_COROUTINES_CORE_JVM,
                    JETBRAINS_KOTLINX_COROUTINES_ANDROID), "com.onesignal.notifications"),
            new BuiltInLibrary(ONESIGNAL_IN_APP_MESSAGES, List.of(ANDROIDX_BROWSER,
                    ANDROIDX_CARDVIEW, ONESIGNAL_CORE, ONESIGNAL_NOTIFICATIONS,
                    JETBRAINS_KOTLIN_STDLIB, JETBRAINS_KOTLINX_COROUTINES_CORE_JVM,
                    JETBRAINS_KOTLINX_COROUTINES_ANDROID), "com.onesignal.inAppMessages"),
            new BuiltInLibrary(ONESIGNAL_LOCATION, List.of(ONESIGNAL_CORE,
                    JETBRAINS_KOTLIN_STDLIB, JETBRAINS_KOTLINX_COROUTINES_CORE_JVM,
                    JETBRAINS_KOTLINX_COROUTINES_ANDROID), "com.onesignal.location"),
