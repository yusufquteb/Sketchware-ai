...
public class AppSettings extends BaseAppCompatActivity {
    ...
    private void setupPreferences(ViewGroup content) {
        ...
        generalCategory.addLibraryItem(createPreference(R.drawable.ic_mtrl_shield_check, "Permissions", "Manage app permissions in one place", new ActivityLauncher(new Intent(getApplicationContext(), PermissionsActivity.class))), true);
        ...
        LibraryCategoryView aiAppearanceCategory = new LibraryCategoryView(this);
        aiAppearanceCategory.setTitle("AI & Appearance");
        preferences.add(aiAppearanceCategory);

        aiAppearanceCategory.addLibraryItem(createPreference(R.drawable.ic_mtrl_settings_applications, "AI Settings", "Configure AI assistant behavior and preferences", new ActivityLauncher(new Intent(getApplicationContext(), AiSettingsActivity.class))), true);
        aiAppearanceCategory.addLibraryItem(createPreference(R.drawable.ic_mtrl_palette, "Theme Settings", "Appearance and color presets", new ActivityLauncher(new Intent(getApplicationContext(), ThemeSettingsActivity.class))), false);
