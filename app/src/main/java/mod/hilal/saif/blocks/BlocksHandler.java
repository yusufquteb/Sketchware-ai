...
public class BlocksHandler {
    ...
    public static void primaryBlocksD(LogicEditorActivity logicEditorActivity) {
        // ── Boolean literals ──────────────────────────────────────────────────
        logicEditorActivity.a("true",                   "b", "true");
        logicEditorActivity.a("false",                  "b", "false");
        // ── Comparison operators ──────────────────────────────────────────────
        logicEditorActivity.a("%d < %d",                "b", "<");
        logicEditorActivity.a("%d = %d",                "b", "=");
        logicEditorActivity.a("%d > %d",                "b", ">");
        // ── Logical operators ─────────────────────────────────────────────────
        logicEditorActivity.a("%b && %b",               "b", "&&");
        logicEditorActivity.a("%b || %b",               "b", "||");
        logicEditorActivity.a("! %b",                   "b", "not");
        // ── Arithmetic operators ──────────────────────────────────────────────
        logicEditorActivity.a("%d + %d",                "d", "+");
        logicEditorActivity.a("%d - %d",                "d", "-");
        logicEditorActivity.a("%d * %d",                "d", "*");
        logicEditorActivity.a("%d / %d",                "d", "/");
        logicEditorActivity.a("%d % %d",                "d", "%");
        logicEditorActivity.a("random %d to %d",        "d", "random");
        // ── String operations ─────────────────────────────────────────────────
        logicEditorActivity.a("length of %s",           "d", "stringLength");
        logicEditorActivity.a("%s join %s",             "s", "stringJoin");
        logicEditorActivity.a("%s indexOf %s",          "d", "stringIndex");
        logicEditorActivity.a("%s lastIndexOf %s",      "d", "stringLastIndex");
        logicEditorActivity.a("%s subString %d to %d",  "s", "stringSub");
        if (showBuiltIn()) {
            logicEditorActivity.a("%s charAt %d",       "s", "stringSubSingle");
        }
        logicEditorActivity.a("%s = %s",                "b", "stringEquals");
        logicEditorActivity.a("%s contains %s",         "b", "stringContains");
        DRPaletteBlock.addStringOperatorBlocks(logicEditorActivity);
        if (showBuiltIn()) {
            logicEditorActivity.a("%s matches %s",      "b", "stringMatches");
        }
        logicEditorActivity.a("%s replace %s to %s",    "s", "stringReplace");
        if (showBuiltIn()) {
            logicEditorActivity.a("%s replaceFirst %s to %s", "s", "stringReplaceFirst");
            logicEditorActivity.a("%s replaceAll %s to %s",   "s", "stringReplaceAll");
            logicEditorActivity.a("reverse %s",         "s", "reverse");
            logicEditorActivity.a("html %s",            "s", "html");
        }
        logicEditorActivity.a("trim %s",                "s", "trim");
        logicEditorActivity.a("%s to upper",            "s", "toUpperCase");
        logicEditorActivity.a("%s to lower",            "s", "toLowerCase");
        // ── Type conversions ──────────────────────────────────────────────────
        logicEditorActivity.a("%s to number",           "d", "toNumber");
        logicEditorActivity.a("parseInt %s",            "d", "strParseInteger");
        logicEditorActivity.a("hashCode %s",            "d", "toHashCode");
        logicEditorActivity.a("SHA1 %s",                "s", "toSHA1");
        logicEditorActivity.a("MD5 %s",                 "s", "toMD5");
        logicEditorActivity.a("%d to string",           "s", "toString");
        logicEditorActivity.a("%d to decimal %d",       "s", "toStringWithDecimal");
        logicEditorActivity.a("format %s args %s",      "s", "toStringFormat");
        // ── Map / ListMap conversions ─────────────────────────────────────────
        logicEditorActivity.a("%s to map",              " ", "strToMap");
        logicEditorActivity.a("map %m.map to string",   "s", "mapToStr");
        logicEditorActivity.a("%s to listmap",          " ", "strToListMap");
        logicEditorActivity.a("listmap %m.listmap to string", "s", "listMapToStr");
        if (showBuiltIn()) {
            logicEditorActivity.a("json %s to list %m.list",  " ", "GsonStringToListString");
            logicEditorActivity.a("json %s to numlist %m.list"," ","GsonStringToListNumber");
            logicEditorActivity.a("list %m.list to json",     "s", "GsonListTojsonString");
            logicEditorActivity.a("split %s by %s into %m.list"," ","stringSplitToList");
        }
        // ── Raw source code ───────────────────────────────────────────────────
        logicEditorActivity.a("add source directly", getTitleBgColor(logicEditorActivity));
        logicEditorActivity.a("source code",            " ", "addSourceDirectly");
        // ── asd (add source directly) typed helpers ───────────────────────────
        logicEditorActivity.a("asd bool",               "b", "asdBoolean");
        logicEditorActivity.a("asd number",             "d", "asdNumber");
        logicEditorActivity.a("asd string",             "s", "asdString");
    }
