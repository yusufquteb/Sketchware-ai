...
import mod.agus.jcoderz.dx.cf.direct.ClassPathOpener.FileNameFilter;
...
public class Main {
    ...
    private mod.agus.jcoderz.dx.dex.file.ClassDefItem translateClass(byte[] bytes, DirectClassFile cf) {
        try {
    ...
    private boolean addClassToDex(mod.agus.jcoderz.dx.dex.file.ClassDefItem clazz) {
    ...
    private void dumpMethod(DexFile dex, String fqName,
        ...
        mod.agus.jcoderz.dx.dex.file.ClassDefItem clazz = dex.getClassOrNull(className);
        ...
        TreeMap<mod.agus.jcoderz.dx.rop.cst.CstNat, EncodedMethod> meths =
        ...
        for (EncodedMethod meth : meths.values()) {
            ...
            mod.agus.jcoderz.dx.rop.annotation.Annotations methodAnnotations =
            ...
            if (methodAnnotations != null) {
                ...
                for (mod.agus.jcoderz.dx.rop.annotation.Annotation a : methodAnnotations.getAnnotations()) {
                    pw.println("    " + a);
                }
            }
    ...
    private class DirectClassFileConsumer implements Callable<Boolean> {
        ...
        private Boolean call(DirectClassFile cf) {
            ...
            Future<mod.agus.jcoderz.dx.dex.file.ClassDefItem> cdif = classTranslatorPool.submit(
    ...
    private class ClassTranslatorTask implements Callable<mod.agus.jcoderz.dx.dex.file.ClassDefItem> {
        ...
        @Override
        public mod.agus.jcoderz.dx.dex.file.ClassDefItem call() {
            mod.agus.jcoderz.dx.dex.file.ClassDefItem clazz = translateClass(bytes, classFile);
            return clazz;
        }
    }
    ...
    private class ClassDefItemConsumer implements Callable<Boolean> {
        ...
        String name;
        Future<mod.agus.jcoderz.dx.dex.file.ClassDefItem> futureClazz;
        int maxMethodIdsInClass;
        int maxFieldIdsInClass;

        private ClassDefItemConsumer(String name, Future<mod.agus.jcoderz.dx.dex.file.ClassDefItem> futureClazz,
