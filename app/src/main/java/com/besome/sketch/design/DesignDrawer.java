...
public class DesignDrawer extends LinearLayout {
    ...
    private final View.OnClickListener drawerItemClickListener = v -> {
        ...
        // Close the drawer first; navigate only after its close animation completes.
        ...
        if (drawerLayout != null && drawerLayout.isDrawerOpen(android.view.Gravity.END)) {
            ...
            drawerLayout.addDrawerListener(new DrawerLayout.SimpleDrawerListener() {
                ...
                public void onDrawerClosed(@NonNull View drawerView) {
                    ...
                    dispatchDrawerItemNavigation(itemId, designActivity);
                }
            });
            drawerLayout.closeDrawer(android.view.Gravity.END);
        } else {
            dispatchDrawerItemNavigation(v.getId(), designActivity);
        }
    };

    @SuppressLint("NonConstantResourceId")
    private void dispatchDrawerItemNavigation(int id, DesignActivity designActivity) {
    ...
    public DesignDrawer(@NonNull Context context, @Nullable AttributeSet attrs) {
        ...
        // ── Section: Assets ───────────────────────────────────
        // كل الموارد المرئية/المسموعة معاً
        ...
        // إعدادات البناء والحماية والضبط المتقدم
        CollapsibleSection build = new CollapsibleSection(context,
                "Build & Config", R.drawable.ic_mtrl_tune, "build_open", false);
        build.addItem(R.id.item_appcompat_manager,     R.drawable.ic_mtrl_inject,
                R.string.design_drawer_menu_injection,         R.string.design_drawer_menu_injection_subtitle);
        build.addItem(R.id.item_manifest_manager,      R.drawable.ic_mtrl_deployed_code,
                R.string.design_drawer_menu_androidmanifest,   R.string.design_drawer_menu_androidmanifest_subtitle);
        build.addItem(R.id.item_used_custom_blocks,    R.drawable.ic_mtrl_block,
                R.string.design_drawer_menu_customblocks,      R.string.design_drawer_menu_customblocks_subtitle);
        build.addItem(R.id.item_code_shrinking_manager,R.drawable.ic_mtrl_shield_lock,
                R.string.design_drawer_menu_proguard,          R.string.design_drawer_menu_proguard_subtitle);
        build.addItem(R.id.item_stringfog_manager,     R.drawable.ic_mtrl_regular_expression,
                R.string.design_drawer_menu_stringfog,         R.string.design_drawer_menu_stringfog_subtitle);
        content.addView(build.build());

        // ── Section: Tools ────────────────────────────────────
        // أدوات التطوير والبحث والمعاينة
        CollapsibleSection tools = new CollapsibleSection(context,
                "Tools", R.drawable.ic_mtrl_frame_source, "tools_open", false);
        tools.addItem(R.id.item_show_src,              R.drawable.ic_mtrl_frame_source,
                R.string.design_drawer_menu_title_source_code, R.string.design_drawer_menu_description_source_code);
        tools.addItem(R.id.item_xml_command_manager,   R.drawable.ic_mtrl_code,
                R.string.design_drawer_menu_title_xml_command, R.string.design_drawer_menu_description_xml_command);
        tools.addItem(R.id.item_logcat_reader,         R.drawable.ic_mtrl_article,
                R.string.design_drawer_menu_title_logcat_reader,R.string.design_drawer_menu_subtitle_logcat_reader);
        tools.addCustomItem(ITEM_SEARCH_IN_PROJECT, R.drawable.ic_mtrl_search,
                "Search in Project", "Find text, classes, or resources");
        tools.addCustomItem(ITEM_TERMINAL, R.drawable.ic_mtrl_code,
                "Terminal", "Shell commands & Python 3 interpreter");
        content.addView(tools.build());

        // Collection Manager moved to Assets section
    }
