...
/**
 * On-canvas editor preview for the {@code MaterialDivider} palette widget
 * (ported from the Sketchware-DayDream fork).
 */
public class ItemMaterialDivider extends MaterialDivider implements ItemView {
    ...
    public ItemMaterialDivider(Context context) {
        super(context);
